        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="ajouter formation.php" class="nav-item nav-link active"><i class="fa fa-plus-circle me-2"></i>Ajouter Formation</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <h4 class="mb-4">Modifier la Formation</h4>
                
                
                
                <form action="../../controller/modifier formation.php" method="POST">
                    <input type="hidden" name="id" value="<?= $formation['id'] ?>">
                    
                    <!-- Titre Field -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="titre" name="titre" 
                               value="<?= htmlspecialchars($formation['titre'] ?? '') ?>" 
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="Description" id="description" 
                                  ...
                                  htmlspecialchars($formation['description'] ?? '') ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" class="form-control" id="duree" name="duree" 
                                       value="<?= htmlspecialchars($formation['duree'] ?? '') ?>" 
                                       placeholder="Durée (heures)" min="1" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="certificat" id="certificatOui" 
                                   value="Oui" <?= ($formation['certificat'] ?? 'Oui') === 'Oui' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="certificatOui">Oui</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="certificat" id="certificatNon" 
                                   value="Non" <?= ($formation['certificat'] ?? '') === 'Non' ? 'checked' : '' ?>>
                    ...
                    <!-- Cancel Button -->
                    <a href="../../controller/modifier formation.php" class="btn btn-outline-secondary ms-2">Annuler</a>
                </form>
            </div>
        </div>
    </div>
...
<!-- [Keep all footer and script sections from ajouter_formation.php] -->