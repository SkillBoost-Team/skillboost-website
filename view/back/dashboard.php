...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="../../views/back/login.php"><i class="fas fa-users"></i> Utilisateurs</a>
            <a href="admin-projects.html"><i class="fas fa-project-diagram"></i> Projets</a>
            <a href="doashboard.php" class="active"><i class="fas fa-graduation-cap"></i> Formations</a>
            <a href="../../views/back/evenements.php"><i class="fas fa-calendar-alt"></i> Événements</a>
            <a href="admin-investments.html"><i class="fas fa-chart-line"></i> Investissements</a>
            <a href="../../views/back/reclamations.php" ><i class="fas fa-exclamation-circle"></i> Réclamations</a>
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
            ...
            <a href="../../views/back/login.php"><i class="fas fa-users"></i> Utilisateurs</a>
            <a href="admin-projects.html"><i class="fas fa-project-diagram"></i> Projets</a>
            <a href="dashboard.php" class="active"><i class="fas fa-graduation-cap"></i> Formations</a>
            <a href="../../views/back/evenements.php"><i class="fas fa-calendar-alt"></i> Événements</a>
            <a href="admin-investments.html"><i class="fas fa-chart-line"></i> Investissements</a>
            <a href="../../views/back/reclamations.php" ><i class="fas fa-exclamation-circle"></i> Réclamations</a>
            <a href="admin-settings.html"><i class="fas fa-cog"></i> Paramètres</a>
                            ...
                            <div class="col-md-3">
                                <div class="stat-card bg-primary">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="count">
                                                <?= isset($stats['Débutant']) ? $stats['Débutant'] : '0' ?>
                                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="stat-card bg-info">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="count">
                                                <?= isset($stats['Intermédiaire']) ? $stats['Intermédiaire'] : '0' ?>
                                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="stat-card bg-success">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="count">
                                                <?= isset($stats['Avancé']) ? $stats['Avancé'] : '0' ?>
                                            </div>
