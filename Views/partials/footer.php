    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="/trainings">Formations</a>
                <a class="btn btn-link" href="/events">Événements</a>
                <a class="btn btn-link" href="/complaints">Réclamations</a>
            </div>
            <div class="col-lg-3 col-md-6">
                <h4 class="text-white mb-3">Contact</h4>
                <p><i class="fa fa-map-marker-alt me-3"></i>Bloc E, Esprit, Cite La Gazelle</p>
                <p><i class="fab fa-whatsapp me-3"></i><a href="https://wa.me/21690044054" class="text-light" target="_blank">+216 90 044 054</a></p>
